...
- simple-app : understand basic build and run Dockerfile. 
- spring-boot-rest-api-and-mysql-app : apply Dockerfile to build mysql,spring boot app and both it's connected.  
- spring-boot-rest-api-and-mysql-app-docker-compose : apply docker-compose*.yml instead dockerfile
